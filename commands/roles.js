...
const ROLES = [
  ...
  },
  {
    ...
    emoji: "🔴",
    description:
      "يلصق التهم باطل — يخلي ولاد الحومة البريئين يبانو مافيا عند لانسبيكتور.",
  ...
  },
  {
    ...
    emoji: "🔴",
    description:
      "يبلع الفم لواحد ليلة بليلة، باش غدوة من ذاك ما يقدرش يهدر فالغروب'",
  ...
  // ── ولاد الحومة (VILLAGE) ───────────────────────────────────────────────────
  {
    ...
    emoji: "🟡",
    description:
      "يخير واحد كل ليلة باش يسلكو من الموت — بصح ما يسلكش نفس الشخص مرتين مور بعضاهم",
  ...
  {
    name: "الشجاع(Vigilante)",
    align: "الحومة",
    emoji: "🟡",
    description:
      "يحب يقتل أعضاء العصابة، يخير واحد يقتلو كل ليلةاذا كان من العصابة يربح، اذا ماكانش يقتل روحو من تأنيب الضمير",
  ...
  },
  {
    ...
    align: "الحومة",
    emoji: "🟡",
    description: "يبين هويتو للناس باش يولي صوتو يسوى زوج",
    imageFile: "mayor.png",
  },
  {
    name: "الحبّاس (Jailer)",
  ...
  },
  {
    ...
    align: "محايد",
    emoji: "🟣",
    description: "يربح اذا قتل 3 عيباد ما يهمش يكونو من العصابة ولا من الحومة",
    imageFile: "baiter.png",
  },
  {
    name: " مول النار(Arsonist)",
    align: "محايد",
    emoji: "🟣",
    description:
...
module.exports = {
  ...
  async execute(ctx, args, gameState, bot, variant = "all") {
    ...
    await sleep(500);
    await sendAlignmentGroup(bot, chatId, "الحومة", "🟡", "أدوار ولاد الحومة");
    await sleep(500);
